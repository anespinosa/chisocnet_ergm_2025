...
El siguiente guión (*script*) corresponde al Workshop **Introducción a los Modelos Exponenciales de Grafos Aleatorios** impartido en la 2nda Conferencia Chilena de Redes Sociales ([ChiSocNet](https://www.chisocnet.org)) y realizado en Santiago de Chile por [Alejandro Espinosa-Rada](https://www.aespinosarada.com) ([Instituto de Sociología](https://sociologia.uc.cl), Pontificia Universidad Católica de Chile, Chile). 
